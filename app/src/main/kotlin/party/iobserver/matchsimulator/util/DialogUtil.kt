 ...
 */
fun showSimpleDialog(context: Context, alertEnum: AlertEnum, @StringRes msg: Int) {
...
fun showFullDialog(context: Context, alertEnum: AlertEnum, @StringRes msg: Int, positiveListener: (dialog: DialogInterface, which: Int) -> Unit) {
    val dialog = AlertDialog.Builder(context)
            .setTitle(alertEnum.title)
            .setIcon(alertEnum.drawable)
            .setMessage(msg)
            .setCancelable(false)
            .setPositiveButton(R.string.dialog_positive, positiveListener)
